...
<div class="h-screen flex flex-row flex-wrap">
    ...
    <div id="sideBar" class="relative flex flex-col flex-wrap bg-white border-r border-gray-300 p-6 flex-none w-64 md:-ml-64 md:fixed md:top-0 md:z-30 md:h-screen md:shadow-xl animated faster">
        ...
        <div class="flex flex-col">
            ...
            <!-- link -->
            <a href="{{asset('./email.html')}}" class="mb-3 capitalize font-medium text-sm hover:text-teal-600 transition ease-in-out duration-500">
            ...
            <!-- link -->
            <a href="{{asset('./typography.html')}}" class="mb-3 capitalize font-medium text-sm hover:text-teal-600 transition ease-in-out duration-500">
            ...
            <!-- link -->
            <a href="{{asset('./alert.html')}}" class="mb-3 capitalize font-medium text-sm hover:text-teal-600 transition ease-in-out duration-500">
            ...
            <!-- link -->
            <a href="{{asset('./buttons.html')}}" class="mb-3 capitalize font-medium text-sm hover:text-teal-600 transition ease-in-out duration-500">

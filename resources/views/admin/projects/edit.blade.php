        ...
        <div class="card-body grid grid-cols-1 gap-6 lg:grid-cols-1">
            <div class="p-4">
                ...
                <form id="form" class="shadow-md rounded-lg px-8 pt-6 pb-8 mb-4"
                    ...
                    <input class="bg-gray-200 block rounded w-full p-2 nt-2 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple form-input" name="description" value="{{old('description', $project->description)}}" type="text">
